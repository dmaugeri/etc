...
beautiful.init("/home/daniel/.config/awesome/themes/custom/theme.lua")
...
for s = 1, screen.count() do
    if s == 1 and beautiful.wallpaper1 then
        gears.wallpaper.maximized(beautiful.wallpaper1, s, true)
    elseif s == 2 and beautiful.wallpaper2 then
        gears.wallpaper.maximized(beautiful.wallpaper2, s, true)
    elseif s == 3 and beautiful.wallpaper3 then
