...
-- Layout manipulation
    ...
    -- Volume
    awful.key({ modkey,           }, "F12",     function () awful.util.spawn("amixer -c 0 set Master 2+ unmute", false) end),
    awful.key({ modkey,           }, "F11",   function () awful.util.spawn("amixer -c 0 set Master 2-", false) end),
